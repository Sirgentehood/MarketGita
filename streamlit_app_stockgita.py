...
BUILD_ID = "v36-stockgita-gold-black-theme"
...
st.markdown("""<style>
/* v36 StockGita gold + black text theme */
.gold-text, .section-title, .today-summary-title, .stage-section-title, .today-summary-label {
  color: var(--amber) !important;
}
